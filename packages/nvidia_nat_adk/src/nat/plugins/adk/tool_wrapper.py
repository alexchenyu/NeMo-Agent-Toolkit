...
def google_adk_tool_wrapper(
    ...
    async def callable_ainvoke(*args, **kwargs) -> Any:
    ...
    async def callable_astream(*args, **kwargs) -> AsyncIterator[Any]:
    ...
    def nat_function(func: Callable[..., object] | None = None,
                     ...
                     input_schema: Any = fn.input_schema) -> Callable[..., Any]:
        """
            ...
            if input_schema is not None:
                setattr(
                    ...
                    inspect.Signature(parameters=[
                        ...
                        for param_name, param_annotation in input_schema.__annotations__.items()
                    ]))
            else:
                # Set an empty signature if no input_schema is provided
                setattr(func_to_wrap, "__signature__", inspect.Signature())
