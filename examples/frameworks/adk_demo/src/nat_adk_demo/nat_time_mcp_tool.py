...
async def get_city_time(config: TimeMCPToolConfig, _builder: Builder):
    """Get city time MCP tool

    Args:
        config (TimeMCPToolConfig): The tool configuration.
        builder (Builder): The NAT builder instance.

    Yields:
        FunctionInfo: The function information for the tool.
    """
