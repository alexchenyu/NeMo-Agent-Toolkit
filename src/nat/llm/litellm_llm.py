...
class LiteLlmModelConfig(LLMBaseConfig, RetryMixin, TemperatureMixin, TopPMixin, ThinkingMixin, name="litellm"):
...
async def litellm_model(config: LiteLlmModelConfig, builder: Builder) -> AsyncIterator[LLMProviderInfo]:
